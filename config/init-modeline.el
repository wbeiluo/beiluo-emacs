...
;; (let* ((m-file-path (expand-file-name "extensions/doom-modeline" user-emacs-directory))
;;        (m-files))
;;   (progn
;;     (push (concat m-file-path "doom-modeline-env.el") m-files)
;;     (push (concat m-file-path "doom-modeline-segments.el") m-files)
;;     (push (concat m-file-path "doom-modeline-core.el") m-files)
;;     (push (concat m-file-path "doom-modeline.el") m-files)
;;     (dolist ())
;;     ))

...
(defconst extensions-consult-dir
  (expand-file-name "extensions/consult" user-emacs-directory))

;; Configuration for Consult
(use-package consult
  :ensure nil
  :load-path extensions-consult-dir
